        ...
        <div className="font-[sans-serif]">
            <div className="flex min-h-screen flex-col items-center justify-center">
                <div className="m-4 grid w-full max-w-6xl items-center gap-4 rounded-md p-4 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] max-md:max-w-lg max-md:gap-8 md:grid-cols-2">
                    <div className="w-full px-4 py-4 md:max-w-md">
                        <form>
                            <div className="mb-12">
                                ...
                                <p className="mt-4 text-sm text-gray-800">
                                    ...
                                    <a
                                        ...
                                        className="ml-1 whitespace-nowrap font-semibold text-primary-light hover:underline"
                                    >
                                        Register here
                                    </a>
                                </p>
                            ...
                            <div className="mt-6 flex flex-wrap items-center justify-between gap-4">
                                <div className="flex items-center">
                                    <input
                                        ...
                                        name="remember-me"
                                        type="checkbox"
                                        className="h-4 w-4 shrink-0 rounded border-gray-300 text-primary-light focus:ring-primary-dark"
                                    />
                                    <label
                                        htmlFor="remember-me"
                            ...
                            <div className="mt-12">
                                <button
                                    type="button"
                                    className="btn-primary-dark w-full rounded-md px-4 py-2.5 text-sm tracking-wide text-white shadow-xl"
                    ...
                    <div className="overflow-clip rounded-xl bg-[#000842] md:h-full">
                        <Image
                            src="/furniture/chair/chair-1-2.avif"
